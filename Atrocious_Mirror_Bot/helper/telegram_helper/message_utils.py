...
from Atrocious_Mirror_Bot import AUTO_DELETE_MESSAGE_DURATION, LOGGER, bot, status_reply_dict, status_reply_dict_lock, \
                Interval, DOWNLOAD_STATUS_UPDATE_INTERVAL
from Atrocious_Mirror_Bot.helper.ext_utils.bot_utils import get_readable_message, setInterval
