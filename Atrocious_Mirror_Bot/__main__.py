...
<br><br>
<b>/{BotCommands.TorrentMirrorCommand}</b> [magnet_link]: Start Mirroring using qBittorrent, Use <b>/{BotCommands.TorrentMirrorCommand} s</b> to select files before downloading
<br><br>
