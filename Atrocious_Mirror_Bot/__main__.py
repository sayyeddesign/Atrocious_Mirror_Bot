...
def start(update, context):
    start_string = f'''Hi {update.message.chat.first_name}, {update.message.chat.last_name} , Atrocious Miror Bot can mirror all your links to Google drive. But in pm or unauthorized group you can use all telegram Mirror tools. If you want to upload in Google Drive you need to join [Atrocious Cloud Drive](https://t.me/joinchat/WKZqyWNHpLViMmI1)
